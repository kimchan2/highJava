...
public class T17_MenuTest extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		// File ment 만들어 보기 => new, save, exit
		
		Menu fileMenu = new Menu("file"); // 주 메뉴
		
		MenuItem newMenuItem = new MenuItem("New"); // 부 메뉴
		MenuItem saveMenuItem = new MenuItem("Save"); // 부 메뉴
		MenuItem exitMenuItem = new MenuItem("Exit"); // 부 메뉴
