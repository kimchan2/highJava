...
public class T19_BarChartTest extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		ser1.getData().add(new XYChart.Data<>("브라질", 26000));
		ser1.getData().add(new XYChart.Data<>("프랑스", 26000));
		ser1.getData().add(new XYChart.Data<>("이탈리아", 26000));
		ser1.getData().add(new XYChart.Data<>("미국", 26000));
		...
		ser3.setName("2017년");
		ser3.getData().add(new XYChart.Data<>("호주", 45600));
