 ...
 * 전체 합계를 구하는 작업을 단독으로 햇을때(1개의 쓰레드를 사용했을때)와
 * 여러 쓰레드로 분할해서 작업할 때의 시간을 확인해 보자.
 */
public class T04_ThreadTest {
	static long TOTAL_SUM = 0L;
	public static void main(String[] args) {
		// 단독으로 처리할 때...
		Thread MyThread1 = new SumThread(1L, 2000000000L);
		...
		System.out.println("협력으로 처리할 때의 처리시간 : " + (endTime - startTime));
	}
}
